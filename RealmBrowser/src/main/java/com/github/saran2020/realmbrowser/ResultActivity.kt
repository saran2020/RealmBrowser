        ...
        override fun onFetchComplete(result: DisplayResult) {
            ...
            if (result.type == RESULT_TYPE_EMPTY.toInt()) {
                ...
                if (result.type == RESULT_TYPE_OBJECT.toInt()
                    ...
                    recyclerResults.adapter = ResultAdapter(this@ResultActivity, fields)
                    ...
                    recyclerResults.adapter = NativeResultsAdapter(this@ResultActivity, fields.fieldValue, result.type - Property.TYPE_ARRAY)
                }
            }
        }
    }
